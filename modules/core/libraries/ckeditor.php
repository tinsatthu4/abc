 <?php
	...
	if (! defined ( 'BASEPATH' ))
		...
		/*
	 * El constructor de la clase debe quedar tal cual, el array que recibe es
	 * enviado desde el controlador
	 */
	...
	class CKEditor {
		...
		/**
		 * URL to the %CKEditor installation directory (absolute or relative to
		 * document root).
		 ...
		 * // Use @@ at the beggining of a string to ouput it without
		 * surrounding quotes.
		...
		/**
		 * Boolean variable indicating whether created code should be printed
		 * out or returned by a function.
		 *
		 * Example 1: get the code creating %CKEditor instance and print it on a
		 * page with the "echo" function.
		 * @code
		 ...
		 *
		 * When %CKEditor is created with the editor() method, a HTML
		 * &lt;textarea&gt; element is created,
		 * it will be displayed to anyone with JavaScript disabled or with
		 ...
		 * Do not change it unless you want to force browsers to not use
		 * previously cached version of %CKEditor.
		 */
		 ...
		 * In incompatible browsers %CKEditor will downgrade to plain HTML
		 * &lt;textarea&gt; element.
		 *
		 * @param $name (string)
		 *        	Name of the %CKEditor instance (this will be also the
		 *        	"name" attribute of textarea element).
		 * @param $value (string)
		 *        	Initial value (optional).
		 * @param $config (array)
		 *        	The specific configurations to apply to this editor
		 *        	instance (optional).
		 * @param $events (array)
		 ...
		 *        	If set, replace all textareas with class className in the
		 *        	page.
		 *        	
		 *        	Example 1: replace all &lt;textarea&gt; elements in the
		 *        	page.
		 *        	@code
		 *        	$CKEditor = new CKEditor();
		 *        	$CKEditor->replaceAll();
		 *        	@endcode
		 *        	
		 *        	Example 2: replace all &lt;textarea
		 *        	class="myClassName"&gt; elements in the page.
		 *        	@code
		 *        	$CKEditor = new CKEditor();
		 ...
		 * Note: this function will have no effect on already created editor
		 * instances.
		 *
		 * @param $event (string)
		 *        	Event name, if not set all event handlers will be removed
		 *        	(optional).
		 */
		 ...
		 *        	Example usage:
		 *        	@code
		 *        	$CKEditor->addGlobalEventHandler('dialogDefinition',
		 *        	'function (ev) {
		 ...
		 * Note: this function will have no effect if the event handler has been
		 * already printed/returned.
		 *
		 * @param $event (string)
		 *        	Event name, if not set all event handlers will be removed
		 *        	(optional).
		...
		/**
		 * Returns the configuration array (global and instance specific
		 * settings are merged into one array).
		 *
		 * @param $config (array)
